...
!!! find chain
!for i in range(1,natom):  ! set the start point with 
!	if (anb(i)==1) and (atom(i)=="CR" or atom(i)=="C"):
!		break
!
!!!! kick out H and alkyl chain
! atom(i)=="CB" or atom(i)=="C=C" or atom(i)=="CAro" or  
